...
<html>
    ...
    <body>
        ...
        <?php
            if ( isset($_GET["productoAgregadoOk"]) ) {
                ?>
            ...
            if ( isset($_GET["productoAgregadoError"]) ) {
                ?>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-10 mt-3">
                    <form action="funciones.php" method="post">
                        <input type="text" name="tb_nombre" value="" placeholder="Nombre del producto" required />
                        <input type="number" name="tb_valor" value="" placeholder="Valor del producto" required />
                        <input type="text" name="tb_descripcion" value="" placeholder="Descripción del producto" required />
                        <input type="submit" name="btn_agregar_producto" value="Agregar producto" class="btn btn-sm btn-primary" />
                    </form>
                </div>
                <!-- /productos -->
            </div>
